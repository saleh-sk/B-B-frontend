        ...
        <form onSubmit={handleSubmit} className='grid gap-5 lg:grid-cols-2'>
          ...
          <label className='space-y-1.5'>
            ...
            <PhoneInput
              ...
              className='flex items-center gap-2 rounded-xl border border-stone-300 bg-white px-3 py-2.5 shadow-sm
          ...
          <button
            type='submit'
            className='inline-flex w-fit justify-self-start items-center gap-2 rounded-xl bg-stone-900 px-5 py-3 text-sm font-semibold
